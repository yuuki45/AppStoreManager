  ...
  return (
    <div className="p-6 max-w-3xl space-y-8">
      ...
      <Card className="border-primary/20 bg-primary/5">
        <CardContent className="py-4">
          <p className="text-sm">
            ...
            （アプリ名、説明文、キーワードなど）を AI で<strong>40以上の言語</strong>に一括翻訳し、
      ...
      <div className="space-y-4">
        <Step number={1} title="OpenAI API キーを登録する" icon={Key}>
          <p>
            AI 翻訳には OpenAI の API キーが必要です。
            利用料は OpenAI に直接課金されます（翻訳1回あたり約 $0.01〜0.05）。
          </p>
          ...
          <p>
            サイドバーの「<strong>設定</strong>」を開き、コピーしたキーを貼り付けて保存します。
            キーは暗号化して安全に保存されます。
          </p>
        </Step>
        ...
        <Step number={4} title="現在の登録値を取得する" icon={RefreshCw}>
          <p>
            プロジェクト一覧から編集したいプロジェクトをクリックすると、3カラム比較画面が表示されます。
          </p>
          <p>
            右上の「<strong>現在値取得</strong>」ボタンを押すと、
            App Store Connect に現在登録されているメタデータが中央カラムに読み込まれます。
            AI が生成した新しい提案値と現在の登録内容を並べて比較できます。
          </p>
        </Step>
        ...
        <Step number={5} title="元文を入力する" icon={PenLine}>
          ...
          <div className="rounded-md bg-muted p-3 space-y-1">
            ...
            <ul className="list-disc list-inside space-y-0.5">
              <li><strong>App Name</strong> — アプリ名（30文字以内）</li>
              <li><strong>Subtitle</strong> — サブタイトル（30文字以内）</li>
              <li><strong>What&apos;s New</strong> — アップデート内容（毎バージョン更新）</li>
              <li><strong>Description</strong> — 説明文（4000文字以内）</li>
              <li><strong>Keywords</strong> — 検索キーワード（100文字以内、カンマ区切り）</li>
              <li><strong>Promotional Text</strong> — プロモーションテキスト（170文字以内、いつでも変更可）</li>
            </ul>
          </div>
          <p>
            各フィールドの右下に<strong>文字数カウンター</strong>が表示されます。
            App Store の制限を超えると赤字になります。
          </p>
          <div className="rounded-md bg-muted p-3 space-y-1">
            ...
            <p>
              ...
              元文を1回入力するだけで全言語に展開できます。
            </p>
          </div>
        </Step>

        <Step number={6} title="AI で翻訳を生成する" icon={Sparkles}>
          <p>
            「<strong>一括AI生成</strong>」ボタンを押すと、入力済みの全項目をまとめて
          ...
          <div className="rounded-md bg-muted p-3 space-y-1">
            ...
            <ul className="list-disc list-inside space-y-0.5">
              ...
              <li>40以上の言語に対応（英語、フランス語、ドイツ語、中国語、韓国語など）</li>
          ...
          <p>
            生成結果は右カラムに表示されます。そのまま手動で編集することもできます。
          </p>
          <div className="rounded-md bg-muted p-3 space-y-1">
            ...
            <p>
              ...
              元文は自動的に共有されるため、1つのプロジェクトに入力するだけで OK です。
            </p>
          </div>
        </Step>

        <Step number={7} title="確認して App Store Connect に反映する" icon={Upload}>
          <p>
            反映したい項目の「<strong>反映対象</strong>」チェックボックスをオンにします。
            「<strong>全選択</strong>」ボタンで全項目をまとめて選択・解除できます。
          </p>
          <p>
            現在値と提案値が異なる項目には
          ...
          <p>
            「<strong>反映</strong>」ボタンを押すと確認ダイアログが表示されます。
          ...
          <div className="rounded-md bg-muted p-3 space-y-1">
            <p className="font-medium text-foreground">一括反映（複数言語）:</p>
            <p>
              プロジェクト一覧のアプリグループにある「<strong>一括反映</strong>」ボタンで、
              全言語分を一度に App Store Connect に反映できます。
            </p>
          </div>
        </Step>

        <Step number={8} title="反映結果を確認する" icon={CheckCircle2}>
          <p>
            反映が完了すると、画面上部に結果カードが表示されます（自動スクロール）。
          </p>
          ...
          <p>
            ...
            多くの場合、「Prepare for Submission」状態のバージョンがないことが原因です。
          </p>
        </Step>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            サイドバーの「<strong>設定</strong>」から OpenAI API キーの登録・更新・削除ができます。
          </p>
          <p>
            API キーは暗号化して保存されます。
            利用料は OpenAI に直接課金され、App Store Manager には一切費用はかかりません。
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              はい、完全無料です。AI 翻訳の利用料のみ OpenAI に直接課金されます（1回あたり約 $0.01〜0.05）。
              ご自身の OpenAI API キーを設定ページから登録してください。
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              <strong>Promotional Text</strong> はいつでも変更可能です（審査不要）。
              その他の項目は「Prepare for Submission」状態のバージョンがある時のみ変更できます。
              App Name と Subtitle の変更は審査対象になります。
            </p>
          </div>
          <div>
            <p className="font-medium text-foreground">Q. 既存の内容を壊してしまわないか心配です</p>
            <p className="mt-1 text-muted-foreground">
              反映前に必ず確認ダイアログが表示されます。
              「現在値取得」で現在の登録内容を確認してから反映することをおすすめします。
              また、反映は選択した項目のみ更新されるため、未選択の項目には影響しません。
            </p>
          </div>
          <div>
